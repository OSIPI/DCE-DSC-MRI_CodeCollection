...
from . import t1_data
from osipi.original.ZA_McGill_CAN.vfa import despot, novifast
...
def setup_module(module):
    ...
    log_init(
        filename_prefix,
        "_ZA_McGill_CAN_t1_novifast",
        ["label", "time (us)", "r1_ref", "r1_measured"],
    )
    log_init(
        filename_prefix,
        "_ZA_McGill_CAN_t1_VFA_lin",
        ["label", "time (us)", "r1_ref", "r1_measured"],
    )
...
def test_ZA_McGill_CAN_t1_novifast(
    ...
    r1_nonlin_meas = 1.0 / t1_nonlin_meas[0]
    ...
    np.testing.assert_allclose(
        [r1_nonlin_meas], [r1_ref], rtol=r_tol, atol=a_tol
    )  # testing
...
def test_ZA_McGill_CAN_t1_VFA_lin(
    label, fa_array, tr_array, s_array, r1_ref, s0_ref, a_tol, r_tol
):
    # NOTES:
    ...
    np.testing.assert_allclose(
        [r1_lin_meas], [r1_ref], rtol=r_tol, atol=a_tol
    )  # testing
