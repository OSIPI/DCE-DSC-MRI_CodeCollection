...
from osipi.original.ST_USyd_AUS.signals2conc import signals2conc
...
def setup_module(module):
    ...
    log_init(
        filename_prefix, "_ST_USyd_AUS", ["label", "time (us)", "conc_ref", "conc_meas"]
    )
...
def test_ST_USydAUS_signals2conc(
