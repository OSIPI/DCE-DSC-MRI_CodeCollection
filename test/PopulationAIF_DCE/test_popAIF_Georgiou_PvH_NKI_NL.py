...
def setup_module(module):
    ...
    log_init(filename_prefix, '_Georgiou_AIF_PvH_NKI_NL', ['label', 'aif_ref', 'cb_measured', 'time (us)'])
...
def test_Georgiou_AIF_PvH_NKI_NL(label, time, cb_ref_values, a_tol, r_tol):
    ...
    log_results(filename_prefix, '_Georgiou_AIF_PvH_NKI_NL', [label, cb_ref_values, AIF_G, f"{exc_time:.0f}"])
