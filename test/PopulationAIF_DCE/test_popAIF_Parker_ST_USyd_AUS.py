...
from osipi.original.ST_USyd_AUS.InputFunctions import AIF, variableAIF, arr_shift
...
@osipi_parametrize(
    arg_names,
    test_data,
    xf_labels=["delay_5.0s", "delay_10.0s", "delay_31.0s", "delay_2.0s"],
)
def test_Parker_AIF_ST_Sydney_AUS(label, time, cb_ref_values, delay, a_tol, r_tol):
    # prepare input data
