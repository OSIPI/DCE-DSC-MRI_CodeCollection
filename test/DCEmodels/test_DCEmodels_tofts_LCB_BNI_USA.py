...
from osipi.original.LCB_BNI_USA.dce import fit_tofts

arg_names = (
    "label, t_array, C_array, ca_array, ta_array, ve_ref, Ktrans_ref, arterial_delay_ref, a_tol_ve, r_tol_ve, "
...
def setup_module(module):
    ...
    log_init(
        filename_prefix,
        "_LCB_BNI_USA_tofts",
        ["label", "time (us)", "Ktrans_ref", "ve_ref", "Ktrans_meas", "ve_meas"],
    )
...
def test_LCB_BNI_USA_tofts_model(
    label,
    t_array,
    C_array,
    ca_array,
