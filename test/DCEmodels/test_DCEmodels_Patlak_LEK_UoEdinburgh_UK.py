...
from osipi.original.LEK_UoEdinburgh_UK.PharmacokineticModelling.models import Patlak
...
def test_LEK_UoEdinburgh_UK_Patlak_model(
    label,
    t_array,
    C_t_array,
    cp_aif_array,
    ...
    output, pcov = curve_fit(
        lambda t, x, y: Patlak([x, y], t, cp_aif_array, toff=0),
        t_array,
        C_t_array,
        p0=X0,
        bounds=bounds,
    ...
    )  # in this case delay_ref is used as delay_meas was 0
...
def test_LEK_UoEdinburgh_UK_Patlak_model_delay(
    label,
    t_array,
    C_t_array,
    cp_aif_array,
    ...
    tic = perf_counter()
    output, pcov = curve_fit(
        lambda t, x, y, delay: Patlak([x, y], t, cp_aif_array, toff=delay),
        t_array,
        C_t_array,
        p0=X0,
        bounds=bounds,
