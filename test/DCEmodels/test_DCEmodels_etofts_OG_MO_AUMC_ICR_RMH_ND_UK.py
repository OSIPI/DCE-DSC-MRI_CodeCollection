...
def test_OG_MO_AUMC_ICR_RMH_ND_UK_extended_tofts_kety_model(label, t_array,
...
def testOG_MO_AUMC_ICR_RMH_ND_UK_extended_tofts_kety_model_delay(label, t_array,
                                                      C_array, ca_array, ta_array, ve_ref, vp_ref,
                                                     Ktrans_ref, arterial_delay_ref, a_tol_ve, r_tol_ve, a_tol_vp,
                                                     r_tol_vp, a_tol_Ktrans, r_tol_Ktrans, a_tol_delay, r_tol_delay):
    # NOTES:
