...
def test_MB_QBI_UoManchester_UK_2cxm_model(
    label,
    t_array,
    C_t_array,
    cp_aif_array,
    ...
    aif = dce_aif.Aif(times=t_array, base_aif=cp_aif_array, aif_type=dce_aif.AifType(3))

    # run code
    tic = perf_counter()
    fp_meas, ps_meas, ve_meas, vp_meas = two_cxm_model.solve_LLS(C_t_array, aif, 0)
