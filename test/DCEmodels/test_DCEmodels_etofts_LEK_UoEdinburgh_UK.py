...
def test_LEK_UoEdinburgh_UK_extended_tofts_kety_model(
    label,
    t_array,
    C_array,
    ca_array,
    ...
    output, pcov = curve_fit(
        lambda t, x, y, z: ExtKety([x, y, z], t, ca_array, toff=0),
        t_array,
        C_array,
        p0=X0,
        bounds=bounds,
...
def test_LEK_UoEdinburgh_UK_extended_tofts_kety_model_delay(
    label,
    t_array,
    C_array,
    ca_array,
    ...
    tic = perf_counter()
    output, pcov = curve_fit(
        lambda t, x, y, z, toff: ExtKety([x, y, z], t, ca_array, toff),
        t_array,
        C_array,
        p0=X0,
        bounds=bounds,
