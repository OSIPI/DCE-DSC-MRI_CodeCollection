...
from osipi.original.OG_MO_AUMC_ICR_RMH_NL_UK.ExtendedTofts.DCE import (
    fit_tofts_model,
    fit_aif,
)
...
def setup_module(module):
    ...
    log_init(
        filename_prefix,
        "_OG_MO_AUMC_ICR_RMH_NL_UK_etofts",
        [
            "label",
            "time (us)",
            "Ktrans_ref",
...
def test_OG_MO_AUMC_ICR_RMH_NL_UK_extended_tofts_kety_model(
    label,
    t_array,
    C_array,
    ca_array,
    ...
    tic = perf_counter()
    try:
        ke, arterial_delay_meas, ve_meas, vp_meas = fit_tofts_model(
            C_array,
            t_array,
            AIF,
            idxs=None,
...
def testOG_MO_AUMC_ICR_RMH_NL_UK_extended_tofts_kety_model_delay(
    label,
    t_array,
    C_array,
    ca_array,
