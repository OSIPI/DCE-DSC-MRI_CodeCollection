...
Ct1 = tofts_model.concentration_from_model(aif, Ktrans, v_e, v_p, tau_a)[0,]
...
Ct2 = tofts_model.concentration_from_model_single([Ktrans, v_e, v_p, tau_a], aif)
...
Ktrans_lls, v_e_lls, v_p_lls = tofts_model.solve_LLS(Ct_n, aif, tau_a)
