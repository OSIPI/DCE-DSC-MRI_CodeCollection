...
import osipi.original.LEK_UoEdinburghUK.PharmacokineticModelling.models as edinburgh1
import osipi.original.MJT_UoEdinburghUK.aifs as edinburgh2_aifs
import osipi.original.MJT_UoEdinburghUK.pk_models as edinburgh2_models
import osipi.original.MJT_UoEdinburghUK.dce_fit as edinburgh2_fit
import osipi.original.OGJ_OsloU_Norway.MRImageAnalysis.DCE.Analyze as oslo
import osipi.original.ST_USydAUS.ModelDictionary as sydney
from osipi.original.MB_QBI_UoManchesterUK.QbiPy.dce_models import dce_aif as manchester_aif
from osipi.original.MB_QBI_UoManchesterUK.QbiPy.dce_models import tofts_model as manchester_tofts
import osipi.original.OG_MO_AUMC_ICR_RMH.ExtendedTofts.DCE as amsterdam
